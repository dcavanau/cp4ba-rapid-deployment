...
1. Onto your bastion host, download the Case package: **https://github.com/IBM/cloud-pak/raw/master/repo/case/ibm-cp-automation-4.0.3.tgz** into a temporary directory, e.g., `/temp`, and extract `ibm-cp-automation-4.0.3.tar` into the same temporary directory, e.g., `/temp`

2. Extract the content of `ibm-cp-automation-4.0.3.tar` into the same temporary directory, e.g., `/temp`
...
5. Apply the catalog sources to pin to the specified versions for IBM Automation Foundation, IBM Foundational Services with Cloud Pak for Business Automation. You can apply the catalog sources below from a command line by creating a YAML file (for example, cp4ba_catalog_sources.yaml) with the catalog sources below and performing `oc apply -f cp4ba_catalog_sources.yaml`, or you can apply the catalog sources using the OCP console
  ...
  spec:
    ...
    publisher: IBM
    sourceType: grpc
    image: icr.io/cpopen/ibm-cp-automation-catalog@sha256:21104adeebd6062a86e0aff5e59515c18670e67a968a859584b29860c9fc5498
    updateStrategy:
      registryPoll:
        interval: 45m
  ---
  # IBM Automation Foundation Base 1.3.10
  apiVersion: operators.coreos.com/v1alpha1
  kind: CatalogSource
  metadata:
  ...
  spec:
    ...
    publisher: IBM
    sourceType: grpc
    image: icr.io/cpopen/ibm-cp-automation-foundation-catalog@sha256:6d71505f10c446e12082e5a2a9d35e3dc1565ea87b85b3f4037585fe129c24b3
    updateStrategy:
      registryPoll:
        interval: 45m
  ---
  # IBM Automation Foundation Core 1.3.10
  apiVersion: operators.coreos.com/v1alpha1
  kind: CatalogSource
  metadata:
  ...
  spec:
    ...
    publisher: IBM
    sourceType: grpc
    image: icr.io/cpopen/ibm-automation-foundation-core-catalog@sha256:41b6d15afa9e93fcb1e94e99fe82fbda38023f795acfcd8817b5ddc9e69365d1
    updateStrategy:
      registryPoll:
        interval: 45m
  ---
