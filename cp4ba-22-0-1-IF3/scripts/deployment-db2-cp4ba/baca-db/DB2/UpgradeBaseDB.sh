...
cp sql/UpgradeBaseDB_21.0.2_to_22.0.1.sql.template sql/UpgradeBaseDB_21.0.2_to_22.0.1.sql
sed -i s/\$base_db_name/"$base_db_name"/ sql/UpgradeBaseDB_21.0.2_to_22.0.1.sql
sed -i s/\$base_db_user/"$base_db_user"/ sql/UpgradeBaseDB_21.0.2_to_22.0.1.sql
echo
echo "Running upgrade script: sql/UpgradeBaseDB_21.0.2_to_22.0.1.sql"
db2 -stvf sql/UpgradeBaseDB_21.0.2_to_22.0.1.sql