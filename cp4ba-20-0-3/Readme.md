# Setting up the Tech Jam Infrastructure (CP4BA v20.0.3)
...
- Install IBM Cloud Pak for Business Automation version 20.0.3 (production deployment, previously called enterprise deployment)
