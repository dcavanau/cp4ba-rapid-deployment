...
cp sql/UpgradeBaseDB_21.0.2_to_20.0.3.sql.template sql/UpgradeBaseDB_21.0.2_to_20.0.3.sql
sed -i s/\$base_db_name/"$base_db_name"/ sql/UpgradeBaseDB_21.0.2_to_20.0.3.sql
sed -i s/\$base_db_user/"$base_db_user"/ sql/UpgradeBaseDB_21.0.2_to_20.0.3.sql
echo
echo "Running upgrade script: sql/UpgradeBaseDB_21.0.2_to_20.0.3.sql"
db2 -stvf sql/UpgradeBaseDB_21.0.2_to_20.0.3.sql