...
echo -e "\n-- This script will upgrade tenant DB from v21.0.2 to v20.0.3"
echo
...
cp sql/UpgradeTenantDB_21.0.2_to_20.0.3.sql.template sql/UpgradeTenantDB_21.0.2_to_20.0.3.sql
sed -i s/\$tenant_db_name/"$tenant_db_name"/ sql/UpgradeTenantDB_21.0.2_to_20.0.3.sql
sed -i s/\$tenant_ontology/"$tenant_ontology"/ sql/UpgradeTenantDB_21.0.2_to_20.0.3.sql
sed -i s/\$tenant_db_user/"$tenant_db_user"/ sql/UpgradeTenantDB_21.0.2_to_20.0.3.sql
echo
echo "Running upgrade script: sql/UpgradeTenantDB_21.0.2_to_20.0.3.sql"
db2 -stvf sql/UpgradeTenantDB_21.0.2_to_20.0.3.sql
