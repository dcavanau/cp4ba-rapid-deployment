# Setting up the Tech Jam Infrastructure (CP4BA v22.0.1 IF002)
...
- Install IBM Cloud Pak for Business Automation version 22.0.1 IF002 (production deployment, previously called enterprise deployment)
